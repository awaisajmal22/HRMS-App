        ...
        children: [
          ...
          Obx(
            ()=>SizedBox(
              ...
              child: SingleChildScrollView(padding: EdgeInsets.symmetric(horizontal: 15.w),
                  child: Column(
                  ...
                  onTap: () async {
                    if (weeklytotalVM.totalHoursController.text != null ||
                      ...
                      bool isSuccess =
                        ...
                        totalHours: weeklytotalVM.totalHoursController.text !=
                                ""
                            ? int.parse(weeklytotalVM.totalHoursController.text)
                            : 0,
