...
import '../Services/edit_daily_total_hours_recruiter_services.dart';

class EditDailyTotalHoursRecruiterViewModel extends GetxController {
  ...
  Future<bool> EditsubmitDailyRecruiterHours({
    required int id,
    ...
    bool isSuccess = await EditDailyHoursRecruiterServices()
        .editdailySubmitHoursRecruiterServices(
      id: id,
      startTime: startTime,
      endTime: endTime,
