...
class UnpaidDatePicker extends StatefulWidget {
  final DateTime endWeekDate;
  UnpaidDatePicker({super.key, required this.endWeekDate});

  @override
  State<UnpaidDatePicker> createState() => _UnpaidDatePickerState();
}

class _UnpaidDatePickerState extends State<UnpaidDatePicker> {
...
class _Body extends StatelessWidget {
  ...
  final dailyTotalVM = Get.put(UnpaidHoursRecruiterViewModel());
