...
import '../Services/daily_total_hours_services.dart';

class DailyTotalHoursViewModel extends GetxController {
  ...
  Future<bool> submitDailyHours({
    ...
    bool isSuccess = await DailyHourServices().dailySubmitHoursServices(
      startTime: startTime,
      endTime: endTime,
