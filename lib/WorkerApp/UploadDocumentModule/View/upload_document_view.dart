...
import '../ViewModel/upload_document_view_model.dart';

class UploadDocumentView extends StatelessWidget {
  UploadDocumentView({super.key});
  int check = Get.arguments;
  final uploadDocumentVM = Get.find<UploadDocumentViewModel>();
  ...
  Widget CameraTabBar({required UploadDocumentViewModel uploadDocVM}) {
    return Padding(
