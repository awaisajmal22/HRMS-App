...
import '../Services/edit_weekly_hours_services.dart';


class EditWeeklyTotalHoursViewModel extends GetxController {
  ...
  Future<bool> editWeeklyHours(
    ...
    bool isSuccess = await EditWeeklyServices().editweeklyHoursServices(
